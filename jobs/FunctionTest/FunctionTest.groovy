...
@Field def ALL_TESTS=[:]
ALL_TESTS["FIT"]=["TEST_GROUP":"-test tests/rackhd20","RUN_FIT_TEST":true,"RUN_CIT_TEST":false,"label":"smoke_test", "EXTRA_HW":"ucs"]
                            ...
                            timeout(90){
                                ...
                                if (test_type != "manifest") {
                                    ...
                                    if( !exists ){
                                        ...
                                        def url = "https://github.com/patelb10/RackHD.git"
                                        def branch = "RAC-4965-t"
